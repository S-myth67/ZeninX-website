...
export default function About() {
  ...
  const missionInView = useInView(missionRef, { once: true, margin: "0px" });
  const visionInView = useInView(visionRef, { once: true, margin: "0px" });
  const valuesInView = useInView(valuesRef, { once: true, margin: "0px" });
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <motion.div
        ...
        transition={{ duration: 0.6 }}
        className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl p-10 shadow-xl border border-gray-200 dark:border-gray-700"
      >
